...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        programs1[3] = new Program("Морские монстры и виды их ловли", LocalTime.parse("20:00"), LocalTime.parse("00:00"));
        ...
        programs2[1] = new Program("Топ 100 смартфонов до 99$ с крйтой камерой", LocalTime.parse("12:00"), LocalTime.parse("00:00"));
